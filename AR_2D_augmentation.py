...
def load_input():
    # example1 is the image to be treated as marker
	input_image = cv2.imread('example1.jpg')
    # example2 is the image to be augmented on the marker
	augment_image = cv2.imread('example2.jpg')
